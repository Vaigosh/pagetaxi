...
<!--=== Content Part ===-->
<div class="container">
    <form class="form-horizontal" role="form" method="POST" action="{{ route('sentinel.register.user') }}">
        {!! csrf_field() !!}
        <!--Reg Block-->
        <div class="reg-block">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <button type="submit" value="Register" class="btn-u btn-block">Зарегистрировать</button>
                </div>
            </div>
        </div>
        <!--End Reg Block-->
