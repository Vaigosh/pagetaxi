        ...
        @foreach($news as $new)
            <div class="row">
                ...
                <div class="">
                    ...
                    {!! Form::open(array('url' => 'news/' . $new->id, 'class' => 'pull-right')) !!}
                        {!! Form::hidden('_method', 'DELETE') !!}
                        {!! Form::submit('Удалить новость', array('class' => 'btn btn-warning')) !!}
                    {!! Form::close() !!}

                    <!-- show the nerd (uses the show method found at GET /nerds/{id} -->
                    <a class="btn btn-small btn-success" href="{{ URL::to('news/' . $new->id) }}">Открыть новость</a>

                    <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                    <a class="btn btn-small btn-info" href="{{ URL::to('news/' . $new->id . '/edit') }}">Редактировать новость</a>
